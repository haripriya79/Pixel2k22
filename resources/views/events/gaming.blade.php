...
<head>
    ...
    <title>Gaming Arena-Pixel 2022</title>
    <meta content="Gamear" name="description" />
            ...
            <div class="w-layout-grid main-grid">
                <div id="w-node-_6ca352aa-f456-95fb-2b6c-2f7d864c63d1-ce4392dc" class="content centered">
                    <div class="show-item-onload margin-paragraph"
                        ...
                        <img src="../images/event-icons/gaming 1.svg" style="min-height: 10px; max-height: 120px;">
                        <h1 class="display-1 small">Gaming Arena</h1>
                    </div>
                </div>
            </div><img
                src="https://assets.website-files.com/5d70f6f0c8ca5de04b4392d5/5d7b5d4b3a8c25e18e4d155d_shape-bottom-2.svg"
            ...
            <div class="w-layout-grid grid-6 margin-bottom ">
                <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c2-ce4392dc" class="content">
                    ...
                    <div class="sticky-content">
                        <h5 class="display-3 font-yellow centered">BGMI Game</h5>
                        <div class="w-layout-grid grid-details-conference-info border ">

                            <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc03-cd4392e2 "
                                class="section padding-2rem ">
                                <div class="content horizontal middle ">
                                    <img src="https://assets.website-files.com/5d70f6f0c8ca5de04b4392d5/5d74eab37a6dfa8086237033_Orion_timekeeping.svg "
                                        alt=" " class="icn-32 " />
                            ...
                            <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc10-cd4392e2 "
                                class="section padding-2rem ">
                                ...
                                <div class="content horizontal middle ">
                                    <img src="https://assets.website-files.com/5d70f6f0c8ca5de04b4392d5/5d73a5847149d55967004dcb_Orion_entrance.svg "
                                        alt=" " class="icn-32 " />
                                    <div class="margin-left ">
                                        <h5 class="display-3 font-yellow ">50/-</h5>
                                        <div>Solo</div>
                                        <h5 class="display-3 font-yellow ">100/-</h5>
                                        <div>Squad</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content"
                    style="padding: 2rem;">


                    <div class="margin-paragraph w-richtext">
                        <h2>About the event</h2>
                        <img src="../images/events/pubg.jpeg" style="width: 100%;margin-top: 1rem;max-height: 280px; margin-bottom: 1rem;" alt="">
                            <p>This event is loaded with fun, participants will compete in the Multi Player game Battle
                                Grounds Mobile India. A custom room will be created where participants are expected to
                                compete in teams, the last team standing will win.</p>
                            <p> </p>
                        <p>
                        <h5>Registration Rules For BGMI Game</h5>
                        <ul>
                            <li>
                                This is an online event and you can participate from anywhere.
                            </li>
                            <li>
                                A Squad can contain 2 to 4 members. Individual is also allowed.
                            </li>
                            <li>
                                Payment of rupees 100 should be paid each Squad.
                            </li>
                            <li>
                                Individual Performers should pay an amount of rupees 50.
                            </li>
                            <li>
                        ...
                        <h5>Event Rules For BGMI Game</h5>
                        <p>
                        <ul>
                            <li>
                                Solo registrations will be teamed up with the Squad available.
                            </li>
                            <li>
                                Hackers will be disqualified.
                            </li>
                            <li>
                                Team up is strictly prohibited and they will be.
                            </li>
                            <li>
                                Only Squad games are played.
                            </li>
                        </ul>
                        </p>
                        <h5>Prize Details For BGMI Game</h5>
                        <p>
                        <ul>
                            <li>
                                Winners will get Rs.1000/-
                            </li>
                            <li>
                               Runner Up will get Rs.500/-
                            </li>
                            <li>
                                For every kill amount will be awarded
                            </li>
                    ...
                    <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533727-cd4392e2" class="content centered">
                        <div class="container medium margin-bottom">
                            <div class="w-layout-grid grid-contact border" style="background-color:#3B3566 ;">
                                <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d53372a-cd4392e2"
                                    class="section padding-2rem">
                                    <div class="content centered">
                                        <div class="show-item-onload margin-paragraph">
                                            <div class="font-yellow uppercase">MOHAMMAD SALMAN
                                            </div>
                                        </div>
                                        <div class="show-item-onload">
                                            <div class="uppercase">
                                                <p style="color: white;">Phone:</p><a href="tel:9490881902"
                                                    class="link-block w-inline-block">9490881902</a>
                                            </div>
                                            <div class="uppercase">
                                                <p style="color:white;">Mail Id:</p> <a
                                                    href="mailto:shaiksalmanssn@gmail.com"
                                                    class="link-block w-inline-block">shaiksalmanssn@gmail.com</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533734-cd4392e2"
                                    class="section padding-2rem">
                                    <div class="line-left"></div>
                                    <div class="content centered">
                                        <div class="show-item-onload margin-paragraph">
                                            <div class="font-yellow uppercase">B SRAVANI</div>
                                        </div>

                                        <div class="show-item-onload margin-paragraph"><br>
                                            <div class="font-yellow uppercase">S.Nawaz</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
