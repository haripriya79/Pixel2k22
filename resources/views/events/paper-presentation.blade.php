...
<head>
    ...
    <title>Paper Presentation-Pixel 2022</title>
    <meta content="Paper Presentation" name="description" />
        ...
        <div class="w-layout-grid main-grid">
            <div id="w-node-_6ca352aa-f456-95fb-2b6c-2f7d864c63d1-ce4392dc" class="content centered">
                <div class="show-item-onload margin-paragraph" style="display: flex;flex-direction: row;align-items: center;">
                    <img src="../images/event-icons/ppt 1.svg" style="min-height: 10px; max-height: 120px;">
                    <h1 class="display-1 small">Paper Presentation</h1>
                </div>
            </div>
        ...
        <div class="w-layout-grid grid-6 margin-bottom ">
                        ...
                        <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc10-cd4392e2 " class="section padding-2rem ">
                            ...
                            <div class="content horizontal middle ">
                                ...
                                <div class="margin-left ">
                                    ...
                                    <div>Solo</div>
                                    <h5 class="display-3 font-yellow ">300/-</h5>
            ...
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content" style="padding: 2rem;">
                ...
                <div class="margin-paragraph w-richtext">
                    ...
                    <img src="../images/events/pptt.jpg" style="width: 100%;margin-top: 1rem;max-height: 280px; margin-bottom: 1rem;" alt="">

                    <p>An Idea is where everything starts, paper presentation lets you showcase your idea to the world and tell them why it inspired you and why you are excited about it. Participants should submit an abstract of their idea before the
                        event and present their idea in detail during the event.</p>
                    <p>This is an in person event and you need to be here to present your idea. </p>
                    <p>
                    <h5>Registration Rules</h5>
                    <ul>
                        <li>
                            Teams containing 2 members and individuals can
                        </li>
                        <li>
                            Payment of rupees 300 should be paid by each team.
                        </li>
                        <li>
                            An individual participant needs to pay an amount of 200 rupees
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            Topics are restricted to Computer Science and it's various domains.
                        </li>
                        <li>
                            Abstracts have to be mailed to the <a href="mailto:pixel2k22.ppt@gmail.com"  style="color:#ebb52f;">
                                pixel2k22.ppt@gmail.com
                    </a>  before April 21 and it should not exceed 300 words.
                        </li>
                        <li>
                            The same idea present in the abstract should be presented in the event.
                        </li>
                        <li>
                            Any kind of malpractice will lead to immediate disqualification of the candidate/team.
                        </li>
                        <li>
                    ...
                    <div class="container medium margin-bottom">
                        <div class="w-layout-grid grid-contact border" style="background-color:#3B3566 ;">
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d53372a-cd4392e2" class="section padding-2rem">
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">K Jaya Krishna Reddy
                                        </div>
                                    </div>
                                    <div class="show-item-onload">
                                        <div class="uppercase">
                                            <p style="color: white;">Phone:</p><a href="tel:9963484497" class="link-block w-inline-block">9963484497</a>
                                        </div>
                                        <div class="uppercase">
                                            <p style="color:white;">Mail Id:</p> <a href="mailto:jayakrishna2000.aa@gmail.com" class="link-block w-inline-block">jayakrishna2000.aa@gmail.com</a>
                                        </div>
                            ...
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533734-cd4392e2" class="section padding-2rem">
                                ...
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">S.V Lakshmi Chandrika</div>
                                    </div>

                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase"><br>S FARJUNA </div>
                                    </div>
                                </div>
                            </div>
                        </div>
