            ...
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content" style="padding: 2rem;">
                ...
                <div class="margin-paragraph w-richtext">
                    ...
                    <ul>
                        ...
                        <li>
                            A problem is solved only if it is succesfully executed with no errors and warnings.
                        </li>
                    </ul>
                    </p>
                        ...
                        <div class="w-layout-grid grid-contact border" style="background-color:#3B3566 ;">
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d53372a-cd4392e2" class="section padding-2rem">
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">Ajjuguttu Lokeswara Reddy
                                        </div>
                                    </div>
                                    <div class="show-item-onload">
                                        <a href="tel:9949282641" class="link-block w-inline-block">
                                            <div class="uppercase">
                                                <p style="color:white;">Phone:</p>9949282641
                                            </div>
                                            <div class="uppercase font-white">
                                                <p style="color:white;">Mail Id:
                                                <p><a href="mailto:lokesh98019801@gmail.com" target="_blank" class="horizontal
                                                    centered
                                                    w-inline-block">
                                                        lokesh98019801@gmail.com
                                                    </a>
                                            </div>
                                        </a>
                                    </div>
