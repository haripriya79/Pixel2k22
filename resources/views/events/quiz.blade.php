...
<head>
    ...
    <title>Quizardry-Pixel 2022</title>
    <meta content="Quizardry" name="description" />
        ...
        <div class="w-layout-grid main-grid">
            <div id="w-node-_6ca352aa-f456-95fb-2b6c-2f7d864c63d1-ce4392dc" class="content centered">
                <div class="show-item-onload margin-paragraph" style="display: flex;flex-direction: row;align-items: center;">
                    <img src="../images/event-icons/quiz 1.svg" style="min-height: 10px; max-height: 120px;">
                    <h1 class="display-1 small">Quizardry</h1>
                </div>
            </div>
        ...
        <div class="w-layout-grid grid-6 margin-bottom ">
                    ...
                    <div class="w-layout-grid grid-details-conference-info border ">
                        ...
                        <div id="w-node-_2011552c-4754-9f48-438c-9b6de46fdc10-cd4392e2 " class="section padding-2rem ">
                            ...
                            <div class="content horizontal middle ">
                                ...
                                <div class="margin-left ">
                                    <h5 class="display-3 font-yellow ">250/-</h5>
            ...
            <div id="w-node-_42a1cb0b-3aad-25c1-41c3-f7c4077c09c6-ce4392dc" class="content" style="padding: 2rem;">
                ...
                <div class="margin-paragraph w-richtext">
                    ...
                    <img src="../images/events/quiz.jpg" style="width: 100%;margin-top: 1rem;max-height: 280px; margin-bottom: 1rem;" alt="">

                    <p>Quizardry tests you experience and expertise in the fields of computer science. You will be given a set of technical questions that are chosen by our team and you are expected to answer those correctly. You will be competing against
                        many teams. The team that answers the more questions will win..</p>
                    <p>This is an in person event, you need to be present here to attend it.. </p>
                    <p>
                    <h5>Registration Rules</h5>
                    <ul>
                        <li>
                            This is a team event, each team can contain 2-3 members.
                        </li>
                        <li>
                            Payment of rupees 250 should be paid by each team, if the team contains 2 memebers.
                        </li>
                        <li>
                            Payment of rupees 300 should be paid by each team, if the team contains 3 memebers.
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            Questions will be restricted to Computer Science Engineering.
                        </li>
                        <li>
                            You can participate as a team and discussions are allowed.
                        </li>
                    
                        <li>
                            The team that provides the most correct answers will be declared as winner.
                        </li>
                    </ul>
                    </p>
                    ...
                    <div class="container medium margin-bottom">
                        <div class="w-layout-grid grid-contact border" style="background-color:#3B3566 ;">
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d53372a-cd4392e2" class="section padding-2rem">
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">M Guru Santhosh Kumar
                                        </div>
                                    </div>
                                    <div class="show-item-onload">
                                        <div class="uppercase">
                                            <p style="color: white;">Phone:</p><a href="tel:6303275354" class="link-block w-inline-block">6300393752</a>
                                        </div>
                                        <div class="uppercase">
                                            <p style="color:white;">Mail Id:</p> <a href="mailto:gurusanthoshkumarmeda@gmail.com" class="link-block w-inline-block">gurusanthoshkumarmeda@gmail.comm</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="w-node-_147ce491-59b4-98ea-0255-9dd00d533734-cd4392e2" class="section padding-2rem">
                                ...
                                <div class="content centered">
                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase">I Sai Nikhila</div>
                                    </div>

                                    <div class="show-item-onload margin-paragraph">
                                        <div class="font-yellow uppercase"><br>G PRIYANKA</div>
                                    </div>
                                </div>
                            </div>
                        </div>
